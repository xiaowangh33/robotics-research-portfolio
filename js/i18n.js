(function () {
  ...
  const zh = {
    ...
    "Questions I hope to explore in future research.": "我希望在未来研究中探索的问题。",
    ...
    "Outdoor locomotion video.": "户外运动视频。",
    "Real-time walking on paved terrain; the page opens with motion rather than a still image.": "铺装地面上的实时行走；页面首屏以动态视频而非静态图片呈现。",
    "Extended field trials.": "完整户外测试。",
    "Long-form outdoor record across grass and track-side terrain.": "涵盖草地与跑道周边地形的较长户外测试记录。",
    "Wheel-legged platform.": "轮足平台。",
    ...
    "Real-robot walking video.": "真机行走视频。",
    "Portrait source retained at its native aspect ratio to avoid artificial stretching.": "保留原始竖屏比例，避免人为拉伸。",
    "55 kg quadruped.": "55 kg 四足机器人。",
    ...
    "Experimental grounding": "实验基础",
    "Hardware experience behind the research question.": "研究问题背后的硬件经验。",
    "The proposed direction is grounded in two instrumented real-robot stacks rather than presented as an isolated concept.": "这一研究方向建立在两套可观测真机控制栈之上，而非孤立的概念设想。",
    "Wheel-legged deployment.": "轮足部署。",
    "Multi-rate PC-MCU-CAN control and outdoor locomotion tests.": "多速率 PC–MCU–CAN 控制与户外运动测试。",
    "Quadruped deployment.": "四足部署。",
    "PPO, PD, EtherCAT torque control, and joint-level diagnostics.": "PPO、PD、EtherCAT 力矩控制与关节级诊断。",
    ...
    "This diagram describes a possible research direction. Interfaces and evaluation criteria would need to be established on instrumented simulation and hardware loops.": "该图描述了一个可能的研究方向。接口和评价标准仍需在可观测的仿真与硬件闭环上建立。",
    ...
    "Continued research": "后续研究",
    "Directions I hope to continue exploring.": "我希望继续探索的方向。",
    "These directions connect my deployment experience with research on adaptation, optimization, failure, and hybrid locomotion.": "这些方向将我的部署经验与自适应、优化、失效和混合运动研究连接起来。",
    ...
    "Fast adaptation and control": "快速自适应与控制",
    ...
    "command path": "命令路径",
    "Command and torque path": "命令与力矩路径",
    "Feedback path": "反馈路径",
    "ONNX policy": "ONNX 策略",
    "shared memory": "共享内存",
    "dual-MCU sync": "双 MCU 同步",
    "commands · feedback · safety": "命令 · 反馈 · 安全",
    "50 Hz · 20 ms action hold": "50 Hz · 动作保持 20 ms",
    "200 Hz · 5 ms refresh": "200 Hz · 5 ms 刷新",
    "1 kHz service": "1 kHz 服务循环",
    "1 kHz recompute · ZOH": "1 kHz 重算 · ZOH",
    "16-D action": "16 维动作",
  ...
  const attributes = {
    ...
    "Wheel-legged robot walking outdoors": "轮足机器人在户外行走",
    "Wheel-legged robot during extended outdoor field trials": "轮足机器人进行较长时间的户外场地测试",
